...
import com.jtechme.jumpgokids.database.HistoryItem;
...
public final class BookmarkEvents {
    ...
    /**
     * The {@link com.jtechme.jumpgokids.fragment.BookmarksFragment} want to know the url (and title)
    ...
    /**
     * Sended by the {@link com.jtechme.jumpgokids.fragment.BookmarksFragment} when it wants to close
     * itself (generally in reply to a {@link com.jtechme.jumpgokids.bus.BrowserEvents.UserPressedBack}
     * event.
     */
